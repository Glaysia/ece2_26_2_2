...
module lcd_modes #(parameter integer POWER_WAIT=50)(
 ...
 always @* begin
  case(shown_mode)
   0:name="AND OR XOR      "; 1:name="FULL ADDER      ";
   2:name="4 BIT ADDER     "; 3:name="4 BIT SUBTRACT  ";
   4:name="4 BIT COMPARE   "; 5:name="4 TO 1 MUX      ";
   6:name="1 TO 8 DEMUX    "; 7:name="8 TO 3 ENCODER  ";
   8:name="3 TO 8 DECODER  "; 9:name="HEX 7 SEGMENT   ";
  ...
  if(rst) begin
   ...
   0:begin
    ...
    case(index)
     ...
     11:begin lcd_rs<=1; lcd_data<=(shown_mode==9)?"1":"0"; end
     12:begin lcd_rs<=1; lcd_data<=(shown_mode==9)?"0":("1"+shown_mode); end
     22:lcd_data<=8'hc0;
     default:begin
      lcd_rs<=1;
