...
add_files -fileset sim_1 [file normalize [file join $project_dir {../../common/tb/tb_logic_gate_modern.sv}]]
...
set_property top tb_logic_gate_modern [get_filesets sim_1]
