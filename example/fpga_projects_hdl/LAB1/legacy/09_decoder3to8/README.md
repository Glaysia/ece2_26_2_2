...
[전체 프로젝트](../../README.md) · [설치](../../docs/setup.md) · [회로별 규칙](../../docs/circuits.md) · [강의 PDF](https://github.com/Glaysia/ece2_26_2_2/blob/daily/0910/weekly-slides/weekly-slides/LAB1_FPGA_0914/04.LAB1_19_DECODER3TO8_LEGACY.pdf) · [실험 전·후 레포트](../../docs/reports.md)

## VS Code에서 먼저 실행

1. 별도 [템플릿](https://github.com/Glaysia/fpga-lab-template)을 clone합니다.
2. VS Code의 File → New Window → Open Workspace from File...에서 `legacy_09_decoder3to8.code-workspace`를 엽니다.
...
[VS Code workspace](legacy_09_decoder3to8.code-workspace) · [Vivado 프로젝트](vivado/decoder3x8.xpr) · [재생성 Tcl](create_project.tcl)

[같은 회로의 다른 버전](../../vivado_2026_1/09_decoder3to8/README.md) · [통합 모드 09](../../docs/integrated.md#mode-09)
...
- [decoder3x8.v](original/decoder3x8.v)
