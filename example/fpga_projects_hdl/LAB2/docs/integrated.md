...
[독립 통합 시뮬레이션](integrated-simulation-validation.json)에서 두 프로젝트 각각 2,848개 검사가 통과했다. [CLI bit 생성](cli-validation.json)은 별도의 WSL 실행이다. 실제 장치 기록·사진·영상은 아직 수행하지 않았다.
