...
\begin{frame}[label=legacy-01]{레거시 01 · 논리 게이트}
\small
...
\begin{frame}[label=legacy-01-contents]{레거시 01 · 실습 목차}
\small
...
\item 선택한 시뮬레이터로 네 입력 조합을 모두 실행한다.
...
\navlink{legacy-01}{레거시 01 처음으로} · \navlink{lab1-contents}{전체 목차 PDF}}
