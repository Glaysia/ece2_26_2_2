...
\small
clone한 폴더에서 다음 경로로 이동한다.\par\vspace{0.22cm}legacy/01\_logic\_gates\par\vspace{0.22cm}legacy\_01\_logic\_gates.code-workspace\par\par\vspace{0.18cm}{\centering\includegraphics[width=\textwidth,height=2.6cm,keepaspectratio,trim=31.5bp 229.5bp 639.75bp 24.75bp,clip]{assets/modern-01/02-workspace.png}\par}\vspace{0.16cm}
