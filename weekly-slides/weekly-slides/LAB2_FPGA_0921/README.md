...
18개 TeX 원고(최신 8·레거시 8·통합 2)는 총 1,113쪽이다. 레거시 원본 221쪽과 기존 실제 GUI 화면을 출처 차이와 함께 연결했다. 새 소스와 일치하는 실제 VS Code 코드 캡처 97개는 GUI 중단으로 미확보 상태다. 초안 PDF를 완성 배포본으로 복사하지 않는다.
