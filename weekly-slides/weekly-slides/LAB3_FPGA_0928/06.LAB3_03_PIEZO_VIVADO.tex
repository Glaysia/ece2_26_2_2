...
\small
clk\_50mhz B6 · rst\_p K4 · piezo Y21\par\vspace{0.32cm}
...
\begin{center}\includegraphics[width=\textwidth,height=6.0cm,keepaspectratio]{captures/03_piezo-vscode-workspace.png}\end{center}
{\tiny 03\_piezo-vscode-workspace}
\end{frame}

\begin{frame}{VS Code · 시뮬레이션 PASS}
\begin{center}\includegraphics[width=\textwidth,height=6.0cm,keepaspectratio]{captures/03_piezo-vscode-pass.png}\end{center}
{\tiny 03\_piezo-vscode-pass}
\end{frame}

\begin{frame}{VS Code · 파형}
\begin{center}\includegraphics[width=\textwidth,height=6.0cm,keepaspectratio]{captures/03_piezo-vscode-wave.png}\end{center}
{\tiny 03\_piezo-vscode-wave}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=6.0cm,keepaspectratio]{captures/03_piezo-vivado-sources.png}\end{center}
{\tiny 03\_piezo-vivado-sources}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=6.0cm,keepaspectratio]{captures/03_piezo-xsim-pass.png}\end{center}
{\tiny 03\_piezo-xsim-pass}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=6.0cm,keepaspectratio]{captures/03_piezo-vivado-bit.png}\end{center}
{\tiny 03\_piezo-vivado-bit}
\end{frame}
