...
\small
clk B6 · reset K4 · enable N8 · direction N4 · phase[3:0] Y20/Y22/AA20/AA21\par\vspace{0.32cm}
...
\captureplaceholder{04\_stepper-vscode-wave}{TB top을 펼쳐 clk·rst·주요 입력·내부 상태·출력을 추가하고 경계 조건이 보이게 확대한다.}
\end{frame}
